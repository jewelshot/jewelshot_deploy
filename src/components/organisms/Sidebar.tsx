...
export function Sidebar() {
  ...
  return (
    <aside
      className={`fixed bottom-0 left-0 top-0 z-[100] w-[260px] border-r border-white/10 bg-[rgba(10,10,10,0.7)] shadow-[4px_0_24px_rgba(0,0,0,0.3)] backdrop-blur-[24px] backdrop-saturate-[200%] panel-transition ${leftOpen ? 'translate-x-0' : '-translate-x-full'}`}
    >
      {/* Sidebar Content */}
