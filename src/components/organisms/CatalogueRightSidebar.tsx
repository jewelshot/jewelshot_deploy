...
export default function CatalogueRightSidebar({
  ...
  return (
    <aside
      className={`fixed bottom-0 right-0 top-0 z-[90] border-l border-[rgba(139,92,246,0.15)] bg-[rgba(10,10,10,0.7)] shadow-[-4px_0_24px_rgba(0,0,0,0.3)] backdrop-blur-[24px] backdrop-saturate-[200%] transition-all duration-[800ms] ease-[cubic-bezier(0.4,0.0,0.2,1)] ${
    ...
    >
      ...
      <button
        ...
        className="absolute left-0 top-1/2 z-10 -translate-x-full -translate-y-1/2 rounded-l-lg border border-r-0 border-[rgba(139,92,246,0.15)] bg-[rgba(10,10,10,0.7)] p-2 backdrop-blur-[24px] transition-all hover:bg-[rgba(139,92,246,0.1)]"
