...
export function TopBar() {
  ...
  return (
    <header
      className="fixed z-50 flex h-16 items-center justify-between border-b border-[rgba(139,92,246,0.15)] bg-[rgba(10,10,10,0.7)] px-4 backdrop-blur-[24px] backdrop-saturate-[200%] transition-all duration-panel ease-panel"
      style={{
