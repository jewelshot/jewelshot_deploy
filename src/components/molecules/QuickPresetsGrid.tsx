...
const QUICK_PRESETS: QuickPreset[] = [
  ...
  },
  {
    ...
    name: 'Joy Burst',
    icon: PartyPopper,
    description: 'Head back laughter, genuine',
    color: 'text-yellow-300',
  },
  {
    id: 'beaming-smile',
    name: 'Beaming Smile',
    icon: Smile,
    description: 'Duchenne joy, sparkling',
    color: 'text-amber-200',
  },
  {
    id: 'playful-giggle',
    name: 'Playful Giggle',
    icon: HandMetal,
    description: 'Hand to mouth, spontaneous',
    color: 'text-pink-200',
  },
  {
    id: 'hair-motion',
    name: 'Hair Motion',
    icon: ZapIcon,
    description: 'Flying hair, dynamic energy',
    color: 'text-purple-200',
  },
  {
    id: 'hard-sun-joy',
    name: 'Hard Sun Joy',
    icon: SunDimIcon,
    description: 'Sharp shadows, sparkling gems',
    color: 'text-orange-300',
  },
  {
    id: 'diamond-sparkle',
  ...
  },
  {
    ...
    name: 'Hand Shadow',
    icon: Shapes,
    description: 'Geometric shadows, editorial',
    color: 'text-slate-300',
  },
  {
    id: 'golden-studio',
    name: 'Golden Studio',
    icon: Thermometer,
    description: 'Warm hard light, summer',
    color: 'text-amber-300',
  },
  {
    id: 'portrait-85mm',
    name: 'Portrait 85mm',
    icon: CircleUser,
    description: 'Classic bust-up, commercial',
    color: 'text-rose-200',
  },
  {
    id: 'clinical-macro',
    name: 'Clinical Macro',
    icon: Microscope,
    description: 'Collarbone focus, minimalist',
  ...
  },
  {
    ...
    name: 'Dynamic 35mm',
    icon: Move3D,
    description: 'Waist up, gesturing',
    color: 'text-violet-200',
  },
  {
    id: 'hyper-real',
    name: 'Hyper Real',
    icon: ScanFace,
    description: '150MP detail, authentic skin',
  ...
  },
  {
    ...
    name: 'Derma Detail',
    icon: FileSearch,
    description: 'Goosebumps, micro-texture',
    color: 'text-stone-200',
  },
];
