          ...
          <>
            ...
            {onApplyArray && (
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-white/15 to-white/10 py-2 text-xs font-medium text-white transition-all hover:from-white/20 hover:to-white/15"
              >
