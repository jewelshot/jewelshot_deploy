          ...
          {config.mode === 'point' && (
            <div className="space-y-2">
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-md bg-purple-500/10 border border-purple-500/30 py-2 text-[10px] text-purple-300 hover:bg-purple-500/20"
              >
