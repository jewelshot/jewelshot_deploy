...
export function RightSidebarToggle() {
  ...
  return (
    ...
    >
      {/* Arrow Icon */}
      <span
        className={`text-[8px] text-white/60 transition-all duration-[400ms] ease-[cubic-bezier(0.4,0.0,0.2,1)] group-hover:text-[rgba(139,92,246,1)] ${rightOpen ? 'rotate-180' : 'rotate-0'} `}
      >
        ‹
      </span>
    </button>
